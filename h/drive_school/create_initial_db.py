...
from school_manage.models import Coach
...
def create_initial_database():
    ...
    if not Coach.objects.exists():
        Coach.objects.create(name='张教练', phone='13800138000', car_plate='京A12345')
        Coach.objects.create(name='李教练', phone='13900139000', car_plate='京B67890')
        print("✓ 创建示例教练数据")
